...
Most of these come down to network reality or how perplexity serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

perplexity rate-limits like any public site. pplx already paces
...
Where a surface is gated, pplx reads a cookie or token you supply
...
`pplx`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pplx actually did
