...
heroTitle: "perplexity, from the command line"
heroLead: "Query Perplexity AI from the command line. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
pplx links <path>           # the pages it links to, each addressable
pplx serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading perplexity by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address perplexity as
  `perplexity://` URIs and follow links across sites. See
